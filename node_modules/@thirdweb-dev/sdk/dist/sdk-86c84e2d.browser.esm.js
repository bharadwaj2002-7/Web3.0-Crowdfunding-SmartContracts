import { cs as RPCConnectionHandler, aO as resolveAddress, aP as signTypedDataInternal, X as getDefaultGasOverrides, aV as ChainId, b1 as getChainProvider, ct as ContractWrapper, aY as NATIVE_TOKEN_ADDRESS, cu as extractFeatures, ae as detectFeatures, aU as getMultichainRegistryAddress, aL as fetchPublishedContractFromPolygon, aK as THIRDWEB_DEPLOYER$1, aM as fetchAndCacheDeployMetadata, aA as getCreate2FactoryAddress, aI as encodeConstructorParamsForImplementation, aH as computeDeploymentInfo, ay as isContractDeployed, J as fetchContractMetadataFromAddress, ar as fetchSourceFilesFromMetadata, a4 as extractConstructorParamsFromAbi, a7 as resolveContractUriFromAddress, aT as getContractPublisherAddress, ad as fetchExtendedReleaseMetadata, bm as AbiSchema, au as COMMON_FACTORY, az as isEIP155Enforced, cv as CUSTOM_GAS_FOR_CHAIN, aJ as getCreate2FactoryDeploymentInfo, aR as CONTRACT_ADDRESSES, cw as AddressZero, aF as computeForwarderAddress, P as PackInitializer, b as MarketplaceV3Initializer, M as MarketplaceInitializer, f as SplitInitializer, V as VoteInitializer, g as TokenInitializer, T as TokenDropInitializer, a as EditionInitializer, E as EditionDropInitializer, c as MultiwrapInitializer, e as SignatureDropInitializer, N as NFTCollectionInitializer, d as NFTDropInitializer, h as PREBUILT_CONTRACTS_MAP, k as getContractName, bI as CommonPlatformFeeSchema, bH as CommonPrimarySaleSchema, bJ as CommonTrustedForwarderSchema, bE as CommonContractSchema, bG as CommonRoyaltySchema, bK as CommonSymbolSchema, aD as computeDeploymentAddress, aC as getInitBytecodeWithSalt, aW as setSupportedChains, j as getContractTypeForRemoteName, b6 as getSignerAndProvider, an as getCompositeABI, b4 as isChainConfig, aS as getContractAddressByChainId, cx as getProcessEnv, bU as DropErc721ContractSchema, i as PREBUILT_CONTRACTS_APPURI_MAP, b0 as EventType } from './index-b21b6dcf.browser.esm.js';
import { ThirdwebStorage } from '@thirdweb-dev/storage';
import { C as ContractPublisher } from './contract-publisher-e8d7b79e.browser.esm.js';
...
import { c as buildTransactionFunction, T as Transaction, f as buildDeployTransactionFunction, D as DeployTransaction } from './transactions-9a468e79.browser.esm.js';
import { i as isNativeToken, a as fetchCurrencyValue, C as ContractEncoder } from './fetchCurrencyValue-395431ac.browser.esm.js';
import EventEmitter from 'eventemitter3';
import invariant from 'tiny-invariant';
import { n as normalizePriceValue } from './normalizePriceValue-adca7ddb.browser.esm.js';
import { defaultChains } from '@thirdweb-dev/chains';
import { GENERATED_ABI } from '@thirdweb-dev/generated-abis';
import { g as getDeploymentInfo, c as createTransactionBatches, a as deployWithThrowawayDeployer, d as deployContractDeterministic } from './deployWithThrowawayDeployer-977fcc44.browser.esm.js';
...
class ThirdwebSDK extends RPCConnectionHandler {
  ...
  async getContractFromAbi(address, abi) {
    const [resolvedAddress, {
      SmartContract
    }] = await Promise.all([resolveAddress(address), import('./smart-contract-b549e1ed.browser.esm.js')]);
    if (this.contractCache.has(resolvedAddress)) {
      return this.contractCache.get(resolvedAddress);
    }
